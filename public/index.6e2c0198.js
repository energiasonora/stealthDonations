...
(function(global1, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define([
        "exports"
    ], factory) : (global1 = typeof globalThis !== "undefined" ? globalThis : global1 || self, factory(global1.ethers = {}));
    ...
    function makeError(message, code, info) {
        ...
        if (error.shortMessage == null) defineProperties(error, {
            ...
            const proxy = new Proxy(this, {
                get: (target, prop, receiver)=>{
                    if (typeof prop === "string") {
                        ...
                        else if (!(prop in target)) return target.getValue.apply(this === receiver ? target : this, [
                            prop
                        ]);
                    }
    ...
    function getValue$1(value) {
        ...
        if (bytes.length !== WordSize) bytes = getBytesCopy(concat([
    ...
    class Writer {
        ...
        writeBytes(value) {
            ...
            if (paddingOffset) bytes = getBytesCopy(concat([
                bytes,
                ...
                if (!emoji && norm.every((cp)=>cp < 128)) {
                    ...
                    if (!chars.length) type = "Emoji";
                        ...
                        for(let i = 1; i < token_count; i++){
                            let cps = tokens[i];
                            if (!cps.is_emoji && CM.has(cps[0])) throw error_placement(`emoji + combining mark: "${str_from_cps(tokens[i - 1])} + ${safe_str_from_cps([
                                cps[0]
                            ])}"`);
                        }
                        check_fenced(norm);
    ...
    function check_group(g, cps) {
        for (let cp of cps){
            if (!group_has_cp(g, cp)) throw error_group_member(g, cp);
        }
        if (g.M) {
            let decomposed = nfd(cps);
            for(let i = 1, e = decomposed.length; i < e; i++)if (NSM.has(decomposed[i])) {
                let j = i + 1;
                for(let cp; j < e && NSM.has(cp = decomposed[j]); j++)for(let k = i; k < j; k++){
    ...
    function namehash(name) {
        ...
        while(comps.length)result = keccak256(concat([
            result,
            keccak256(comps.pop())
        ]));
        return hexlify(result);
    ...
    class Transaction {
        ...
        inferTypes() {
            ...
            if (this.maxFeePerGas != null && this.maxPriorityFeePerGas != null) assert(this.maxFeePerGas >= this.maxPriorityFeePerGas, "priorityFee cannot be more than maxFee", "BAD_DATA", {
                value: this
            });
    ...
    class Interface {
        ...
        constructor(fragments){
            ...
            if (!this.deploy) defineProperties(this, {
        ...
        encodeFilterTopics(fragment, values) {
            ...
            const encodeTopic = (param, value)=>{
                ...
                else if (param.type === "address") this.#abiCoder.encode([
                    "address"
                ], [
                    value
                ]);
    ...
    async function getSubInfo(contract, event) {
        ...
        if (Array.isArray(event)) {
            ...
            if (isHexString(event, 32)) topics = [
                event
            ];
            else {
        ...
        constructor(target, abi, runner, _deployTx){
            ...
            if (typeof target === "string") {
                if (isHexString(target)) {
                    ...
                    if (!canResolve(resolver)) throw makeError("contract runner does not support name resolution", "UNSUPPORTED_OPERATION", {
                        operation: "resolveName"
                    });
                    addrPromise = resolver.resolveName(target).then((addr)=>{
                        if (addr == null) throw makeError("an ENS name used for a contract target must be correctly configured", "UNCONFIGURED_NAME", {
                            value: target
                        });
    ...
    class AbstractProvider {
        ...
        async getNetwork() {
            ...
            if (expected.chainId !== actual.chainId) {
                ...
                } else assert(false, `network changed: ${expected.chainId} => ${actual.chainId} `, "NETWORK_ERROR", {
                    event: "changed"
                });
            }
    ...
    function parseOffchainLookup(data) {
        ...
        assert(dataLength(data) >= 160, "insufficient OffchainLookup data", "OFFCHAIN_FAULT", {
            ...
            if ((pop.type === 2 || pop.type == null) && pop.maxFeePerGas != null && pop.maxPriorityFeePerGas != null) pop.type = 2;
                ...
                if (pop.type == null) {
                    if (feeData.maxFeePerGas != null && feeData.maxPriorityFeePerGas != null) {
                        ...
                        if (pop.gasPrice == null) pop.gasPrice = feeData.gasPrice;
                        pop.type = 0;
                    } else assert(false, "failed to get consistent fee data", "UNSUPPORTED_OPERATION", {
    ...
    class JsonRpcApiProvider extends AbstractProvider {
            ...
            if (req.method === "call" || req.method === "estimateGas") {
                ...
                if (tx && tx.type != null && getBigInt(tx.type)) {
                    if (tx.maxFeePerGas == null && tx.maxPriorityFeePerGas == null) {
                        ...
                        if (feeData.maxFeePerGas == null && feeData.maxPriorityFeePerGas == null) req = Object.assign({}, req, {
                            transaction: Object.assign({}, tx, {
                                type: undefined
                            })
                        });
        ...
        send(method, params) {
            if (this.destroyed) return Promise.reject(makeError("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", {
                operation: method
            }));
        ...
        async getSigner(address) {
            ...
            for (const account of accounts){
                if (getAddress(account) === address) return new JsonRpcSigner(this, address);
            }
        ...
        destroy() {
            ...
            for (const { payload, reject } of this.#payloads)reject(makeError("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", {
                operation: payload.method
            }));
            this.#payloads = [];
            super.destroy();
    ...
    class EtherscanProvider extends AbstractProvider {
        ...
        getUrl(module1, params) {
            ...
            return `${this.getBaseUrl()}/api?module=${module1}${query}${apiKey}`;
        }
        getPostUrl() {
            return `${this.getBaseUrl()}/api`;
        }
        getPostData(module1, params) {
            params.module = module1;
        ...
        async fetch(module1, params, post) {
            const id = nextId++;
            const url = post ? this.getPostUrl() : this.getUrl(module1, params);
            const payload = post ? this.getPostData(module1, params) : null;
            this.emit("debug", {
                action: "sendRequest",
                id: id,
                url: url,
        ...
        _checkError(req, error, transaction) {
            ...
            if (req.method === "estimateGas") {
                if (!message.match(/revert/i) && message.match(/insufficient funds/i)) assert(false, "insufficient funds", "INSUFFICIENT_FUNDS", {
            ...
            if (message) {
                if (req.method === "broadcastTransaction") {
                    ...
                    if (message.match(/replacement/i) && message.match(/underpriced/i)) assert(false, "replacement fee too low", "REPLACEMENT_UNDERPRICED", {
                        transaction: transaction
                    });
                    if (message.match(/insufficient funds/)) assert(false, "insufficient funds for intrinsic transaction cost", "INSUFFICIENT_FUNDS", {
                        transaction: transaction
                    });
                    if (message.match(/same hash was already imported|transaction nonce is too low|nonce too low/)) assert(false, "nonce has already been used", "NONCE_EXPIRED", {
                        transaction: transaction
                    });
                }
            }
    ...
    class FallbackProvider extends AbstractProvider {
        ...
        constructor(providers, network, options){
            ...
            this.#configs = providers.map((p)=>{
                if (p instanceof AbstractProvider) return Object.assign({
                    provider: p
            ...
            if (!initialSync) {
                ...
                this.#initialSyncPromise = initialSync = (async ()=>{
                    ...
                    for (const config of this.#configs){
                        ...
                        else if (network.chainId !== chainId) assert(false, "cannot mix providers on different networks", "UNSUPPORTED_OPERATION", {
    ...
    function getDefaultProvider(network, options) {
        ...
        if (allowService("publicPolygon") && staticNetwork) {
            if (staticNetwork.name === "matic") providers.push(new JsonRpcProvider("https://polygon-rpc.com/", staticNetwork, {
                staticNetwork: staticNetwork
            }));
            else if (staticNetwork.name === "matic-amoy") providers.push(new JsonRpcProvider("https://rpc-amoy.polygon.technology/", staticNetwork, {
                staticNetwork: staticNetwork
            }));
        }
    ...
    exports1.AbiCoder = AbiCoder;
    exports1.AbstractProvider = AbstractProvider;
    exports1.AbstractSigner = AbstractSigner;
    exports1.AlchemyProvider = AlchemyProvider;
    exports1.AnkrProvider = AnkrProvider;
    exports1.BaseContract = BaseContract;
    exports1.BaseWallet = BaseWallet;
    exports1.Block = Block;
    exports1.BrowserProvider = BrowserProvider;
    exports1.ChainstackProvider = ChainstackProvider;
    exports1.CloudflareProvider = CloudflareProvider;
    exports1.ConstructorFragment = ConstructorFragment;
    exports1.Contract = Contract;
    exports1.ContractEventPayload = ContractEventPayload;
    exports1.ContractFactory = ContractFactory;
    exports1.ContractTransactionReceipt = ContractTransactionReceipt;
    exports1.ContractTransactionResponse = ContractTransactionResponse;
    exports1.ContractUnknownEventPayload = ContractUnknownEventPayload;
    exports1.EnsPlugin = EnsPlugin;
    exports1.EnsResolver = EnsResolver;
    exports1.ErrorDescription = ErrorDescription;
    exports1.ErrorFragment = ErrorFragment;
    exports1.EtherSymbol = EtherSymbol;
    exports1.EtherscanPlugin = EtherscanPlugin;
    exports1.EtherscanProvider = EtherscanProvider;
    exports1.EventFragment = EventFragment;
    exports1.EventLog = EventLog;
    exports1.EventPayload = EventPayload;
    exports1.FallbackFragment = FallbackFragment;
    exports1.FallbackProvider = FallbackProvider;
    exports1.FeeData = FeeData;
    exports1.FeeDataNetworkPlugin = FeeDataNetworkPlugin;
    exports1.FetchCancelSignal = FetchCancelSignal;
    exports1.FetchRequest = FetchRequest;
    exports1.FetchResponse = FetchResponse;
    exports1.FetchUrlFeeDataNetworkPlugin = FetchUrlFeeDataNetworkPlugin;
    exports1.FixedNumber = FixedNumber;
    exports1.Fragment = Fragment;
    exports1.FunctionFragment = FunctionFragment;
    exports1.GasCostPlugin = GasCostPlugin;
    exports1.HDNodeVoidWallet = HDNodeVoidWallet;
    exports1.HDNodeWallet = HDNodeWallet;
    exports1.Indexed = Indexed;
    exports1.InfuraProvider = InfuraProvider;
    exports1.InfuraWebSocketProvider = InfuraWebSocketProvider;
    exports1.Interface = Interface;
    exports1.IpcSocketProvider = IpcSocketProvider;
    exports1.JsonRpcApiProvider = JsonRpcApiProvider;
    exports1.JsonRpcProvider = JsonRpcProvider;
    exports1.JsonRpcSigner = JsonRpcSigner;
    exports1.LangEn = LangEn;
    exports1.Log = Log;
    exports1.LogDescription = LogDescription;
    exports1.MaxInt256 = MaxInt256;
    exports1.MaxUint256 = MaxUint256;
    exports1.MessagePrefix = MessagePrefix;
    exports1.MinInt256 = MinInt256;
    exports1.Mnemonic = Mnemonic;
    exports1.MulticoinProviderPlugin = MulticoinProviderPlugin;
    exports1.N = N$1;
    exports1.NamedFragment = NamedFragment;
    exports1.Network = Network;
    exports1.NetworkPlugin = NetworkPlugin;
    exports1.NonceManager = NonceManager;
    exports1.ParamType = ParamType;
    exports1.PocketProvider = PocketProvider;
    exports1.QuickNodeProvider = QuickNodeProvider;
    exports1.Result = Result;
    exports1.Signature = Signature;
    exports1.SigningKey = SigningKey;
    exports1.SocketBlockSubscriber = SocketBlockSubscriber;
    exports1.SocketEventSubscriber = SocketEventSubscriber;
    exports1.SocketPendingSubscriber = SocketPendingSubscriber;
    exports1.SocketProvider = SocketProvider;
    exports1.SocketSubscriber = SocketSubscriber;
    exports1.StructFragment = StructFragment;
    exports1.Transaction = Transaction;
    exports1.TransactionDescription = TransactionDescription;
    exports1.TransactionReceipt = TransactionReceipt;
    exports1.TransactionResponse = TransactionResponse;
    exports1.Typed = Typed;
    exports1.TypedDataEncoder = TypedDataEncoder;
    exports1.UndecodedEventLog = UndecodedEventLog;
    exports1.UnmanagedSubscriber = UnmanagedSubscriber;
    exports1.Utf8ErrorFuncs = Utf8ErrorFuncs;
    exports1.VoidSigner = VoidSigner;
    exports1.Wallet = Wallet;
    exports1.WebSocketProvider = WebSocketProvider;
    exports1.WeiPerEther = WeiPerEther;
    exports1.Wordlist = Wordlist;
    exports1.WordlistOwl = WordlistOwl;
    exports1.WordlistOwlA = WordlistOwlA;
    exports1.ZeroAddress = ZeroAddress;
    exports1.ZeroHash = ZeroHash;
    exports1.accessListify = accessListify;
    exports1.assert = assert;
    exports1.assertArgument = assertArgument;
    exports1.assertArgumentCount = assertArgumentCount;
    exports1.assertNormalize = assertNormalize;
    exports1.assertPrivate = assertPrivate;
    exports1.checkResultErrors = checkResultErrors;
    exports1.computeAddress = computeAddress;
    exports1.computeHmac = computeHmac;
    exports1.concat = concat;
    exports1.copyRequest = copyRequest;
    exports1.dataLength = dataLength;
    exports1.dataSlice = dataSlice;
    exports1.decodeBase58 = decodeBase58;
    exports1.decodeBase64 = decodeBase64;
    exports1.decodeBytes32String = decodeBytes32String;
    exports1.decodeRlp = decodeRlp;
    exports1.decryptCrowdsaleJson = decryptCrowdsaleJson;
    exports1.decryptKeystoreJson = decryptKeystoreJson;
    exports1.decryptKeystoreJsonSync = decryptKeystoreJsonSync;
    exports1.defaultPath = defaultPath;
    exports1.defineProperties = defineProperties;
    exports1.dnsEncode = dnsEncode;
    exports1.encodeBase58 = encodeBase58;
    exports1.encodeBase64 = encodeBase64;
    exports1.encodeBytes32String = encodeBytes32String;
    exports1.encodeRlp = encodeRlp;
    exports1.encryptKeystoreJson = encryptKeystoreJson;
    exports1.encryptKeystoreJsonSync = encryptKeystoreJsonSync;
    exports1.ensNormalize = ensNormalize;
    exports1.ethers = ethers;
    exports1.formatEther = formatEther;
    exports1.formatUnits = formatUnits;
    exports1.fromTwos = fromTwos;
    exports1.getAccountPath = getAccountPath;
    exports1.getAddress = getAddress;
    exports1.getBigInt = getBigInt;
    exports1.getBytes = getBytes;
    exports1.getBytesCopy = getBytesCopy;
    exports1.getCreate2Address = getCreate2Address;
    exports1.getCreateAddress = getCreateAddress;
    exports1.getDefaultProvider = getDefaultProvider;
    exports1.getIcapAddress = getIcapAddress;
    exports1.getIndexedAccountPath = getIndexedAccountPath;
    exports1.getNumber = getNumber;
    exports1.getUint = getUint;
    exports1.hashMessage = hashMessage;
    exports1.hexlify = hexlify;
    exports1.id = id;
    exports1.isAddress = isAddress;
    exports1.isAddressable = isAddressable;
    exports1.isBytesLike = isBytesLike;
    exports1.isCallException = isCallException;
    exports1.isCrowdsaleJson = isCrowdsaleJson;
    exports1.isError = isError;
    exports1.isHexString = isHexString;
    exports1.isKeystoreJson = isKeystoreJson;
    exports1.isValidName = isValidName;
    exports1.keccak256 = keccak256;
    exports1.lock = lock;
    exports1.makeError = makeError;
    exports1.mask = mask;
    exports1.namehash = namehash;
    exports1.parseEther = parseEther;
    exports1.parseUnits = parseUnits$1;
    exports1.pbkdf2 = pbkdf2;
    exports1.randomBytes = randomBytes;
    exports1.recoverAddress = recoverAddress;
    exports1.resolveAddress = resolveAddress;
    exports1.resolveProperties = resolveProperties;
    exports1.ripemd160 = ripemd160;
    exports1.scrypt = scrypt;
    exports1.scryptSync = scryptSync;
    exports1.sha256 = sha256;
    exports1.sha512 = sha512;
    exports1.showThrottleMessage = showThrottleMessage;
    exports1.solidityPacked = solidityPacked;
    exports1.solidityPackedKeccak256 = solidityPackedKeccak256;
    exports1.solidityPackedSha256 = solidityPackedSha256;
    exports1.stripZerosLeft = stripZerosLeft;
    exports1.toBeArray = toBeArray;
    exports1.toBeHex = toBeHex;
    exports1.toBigInt = toBigInt;
    exports1.toNumber = toNumber;
    exports1.toQuantity = toQuantity;
    exports1.toTwos = toTwos;
    exports1.toUtf8Bytes = toUtf8Bytes;
    exports1.toUtf8CodePoints = toUtf8CodePoints;
    exports1.toUtf8String = toUtf8String;
    exports1.uuidV4 = uuidV4;
    exports1.verifyMessage = verifyMessage;
    exports1.verifyTypedData = verifyTypedData;
    exports1.version = version;
    exports1.wordlists = wordlists;
    exports1.zeroPadBytes = zeroPadBytes;
    exports1.zeroPadValue = zeroPadValue;
});

//# sourceMappingURL=index.6e2c0198.js.map
